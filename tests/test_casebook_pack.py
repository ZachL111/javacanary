"""Regression checks for the javacanary casebook."""
...
from casebook.harness import assert_expected, javacanary_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(javacanary_summary(), assert_expected())
